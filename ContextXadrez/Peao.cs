        ...
        public override bool[,] MovimentosPossiveis()
        {
            ...
            if (Cor == Cor.Branca)
            {
                ...
                if (Posicao.Linha == 3)
                {
                    ...
                    if (Tabuleiro.PosicaoValida(esquerda) && existeInimigo(esquerda) && Tabuleiro.Peca(esquerda) == _partida.VuneravelEnPassant)
                    {
                        mat[esquerda.Linha - 1, esquerda.Coluna] = true;
                    }
                    Posicao direita = new Posicao(Posicao.Linha, Posicao.Coluna + 1);
                    if (Tabuleiro.PosicaoValida(direita) && existeInimigo(direita) && Tabuleiro.Peca(direita) == _partida.VuneravelEnPassant)
                    {
